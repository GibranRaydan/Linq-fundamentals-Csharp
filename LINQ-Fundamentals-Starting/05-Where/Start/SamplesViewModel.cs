namespace LINQSamples
{
    public class SamplesViewModel : ViewModelBase
    {
        ...
        public List<Product> WhereMethod()
        {
            ...
            list = products.Where(prod => prod.Name.ToLowerInvariant().StartsWith('s'))
                .ToList();
        ...
        public List<Product> WhereTwoFieldsQuery()
        {
            ...
            // Write Query Syntax Here
            list = (from prod in products
                    where prod.Name.StartsWith('s') && prod.StandardCost > 200
                    select prod).ToList();
        ...
        public List<Product> WhereTwoFieldsMethod()
        {
            ...
            // Write Method Syntax Here
            list = products.Where(prod => 
                 prod.Name.ToLowerInvariant().StartsWith('s')
